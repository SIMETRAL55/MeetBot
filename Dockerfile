...
RUN mkdir -p /app/data/uploads /app/results /app/db /app/prepared

# Default environment variables
ENV WEB_HOST=0.0.0.0
ENV WEB_PORT=8080
ENV TRANSCRIPTION_BACKEND=local
ENV USE_LOCAL_LLM=true
ENV DEVICE=cuda
ENV OUTPUT_DIR=/app/results
ENV VECTOR_DB_PATH=/app/db/default
ENV CACHE_DIR=/app/.cache_hf
ENV PREPARED_DOCS_DIR=/app/prepared
